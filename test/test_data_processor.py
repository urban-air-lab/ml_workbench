import pandas as pd
import pytest
from app.data_processor import align_dataframes_by_time
...
def test_no_overlap_returns_empty_dataframes():
...
def test_string_and_datetime_index_conversion():
...
def test_empty_input_dataframes():
...
def test_invalid_datetime_strings_raises():
