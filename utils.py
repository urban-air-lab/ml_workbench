...
class SensorData:
    ...
    def __read_sonta(self) -> pd.DataFrame:
    ...
    def __read_futuredata(self) -> pd.DataFrame:
    ...
    @property
    def get_NO2(self) -> pd.DataFrame:
        return self.all_data["NO2"]

    @property
    def get_difference_electrodes_no2(self) -> pd.DataFrame:
